...
public static class LWFrameworkCSharpProjectQuickOpenerMenuGenerated
{
    ...
    [MenuItem("Assets/LWFramework/C#工程/用槽位打开/槽位2 - Visual Studio Professional 2019 [16.11.4", false, 2002)]
    private static void OpenWithSlot1() { LWFrameworkCSharpProjectQuickOpener.OpenCSharpProjectWithSlot(1); }
    [MenuItem("Assets/LWFramework/C#工程/用槽位打开/槽位2 - Visual Studio Professional 2019 [16.11.4", true)]
    ...
    [MenuItem("Assets/LWFramework/C#工程/用槽位打开/槽位4 - Code", false, 2004)]
    private static void OpenWithSlot3() { LWFrameworkCSharpProjectQuickOpener.OpenCSharpProjectWithSlot(3); }
    [MenuItem("Assets/LWFramework/C#工程/用槽位打开/槽位4 - Code", true)]
    ...
    [MenuItem("Assets/LWFramework/C#工程/设为默认/槽位2 - Visual Studio Professional 2019 [16.11.4", false, 2202)]
    private static void SetDefaultSlot1() { LWFrameworkCSharpProjectQuickOpener.SetDefaultSlotIndex(1); }
    [MenuItem("Assets/LWFramework/C#工程/设为默认/槽位2 - Visual Studio Professional 2019 [16.11.4", true)]
    private static bool SetDefaultSlot1Validate() { Menu.SetChecked("Assets/LWFramework/C#工程/设为默认/槽位2 - Visual Studio Professional 2019 [16.11.4", LWFrameworkCSharpProjectQuickOpener.GetDefaultSlotIndex() == 1); return !EditorApplication.isCompiling; }
    ...
    [MenuItem("Assets/LWFramework/C#工程/设为默认/槽位4 - Code", false, 2204)]
    private static void SetDefaultSlot3() { LWFrameworkCSharpProjectQuickOpener.SetDefaultSlotIndex(3); }
    [MenuItem("Assets/LWFramework/C#工程/设为默认/槽位4 - Code", true)]
    private static bool SetDefaultSlot3Validate() { Menu.SetChecked("Assets/LWFramework/C#工程/设为默认/槽位4 - Code", LWFrameworkCSharpProjectQuickOpener.GetDefaultSlotIndex() == 3); return !EditorApplication.isCompiling; }
    ...
    [MenuItem("Assets/LWFramework/C#工程/清空槽位/槽位2 - Visual Studio Professional 2019 [16.11.4", false, 2302)]
    private static void ClearSlot1() { LWFrameworkCSharpProjectQuickOpener.ClearEditorSlot(1); }
    [MenuItem("Assets/LWFramework/C#工程/清空槽位/槽位2 - Visual Studio Professional 2019 [16.11.4", true)]
    ...
    [MenuItem("Assets/LWFramework/C#工程/清空槽位/槽位4 - Code", false, 2304)]
    private static void ClearSlot3() { LWFrameworkCSharpProjectQuickOpener.ClearEditorSlot(3); }
    [MenuItem("Assets/LWFramework/C#工程/清空槽位/槽位4 - Code", true)]
